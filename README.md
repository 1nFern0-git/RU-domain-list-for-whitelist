...
Этот проект собирает домены и ip адреса в зоне RU для создания белых списков операторов в России

## Цель этого проекта

Его можно использовать для генерации правил маршрутизации
